...
// All the types of objects in the game
 const OBJECT_TYPE = {
  BLANK: 'blank',
  WALL: 'wall',
  DOT: 'dot',
...
class GameBoard {
    ...
    // Function to show a game win or game over screen
    ...
    createGrid(level) {
      ...
      level.forEach((square) => {
        ...
        // Adds dots to the appropriate spaces
